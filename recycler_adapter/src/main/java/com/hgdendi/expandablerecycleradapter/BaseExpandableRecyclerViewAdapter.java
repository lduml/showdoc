...
public abstract class BaseExpandableRecyclerViewAdapter
    ...
    abstract public void childItemOnclick(GroupBean groupBean,ChildBean childBean);
    //继承者 要实现的抽象方法---getGroupCount
    abstract public int getGroupCount();

    //继承者 要实现的抽象方法---getGroupItem
    ...
    public void setListener(ExpandableRecyclerViewOnClickListener<GroupBean, ChildBean> listener) {
        mListener = listener;
    }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                   ...
                   childItemOnclick(groupBean,childBean);
                }
            }
        });
    }
