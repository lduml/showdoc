...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mTestInButton = (Button) findViewById(R.id.test_cookie_button);
        mTestInButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void attemptLogin() {
        ...
        String vcode = edt_vcode.getText().toString();
...
/*
            mAuthTask = new UserLoginTask(email, password,vcode);
